 ...
 */
export const bulkImportSpmQuestionsQuestionsBulkImportPost = <ThrowOnError extends boolean = false>(options: Options<BulkImportSpmQuestionsQuestionsBulkImportPostData, ThrowOnError>) => {
    return (options.client ?? client).post<BulkImportSpmQuestionsQuestionsBulkImportPostResponses, BulkImportSpmQuestionsQuestionsBulkImportPostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const bulkSetPublishStatusQuestionsBulkStatusPost = <ThrowOnError extends boolean = false>(options: Options<BulkSetPublishStatusQuestionsBulkStatusPostData, ThrowOnError>) => {
    return (options.client ?? client).post<BulkSetPublishStatusQuestionsBulkStatusPostResponses, BulkSetPublishStatusQuestionsBulkStatusPostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * catalogue.
 */
export const getSubjectBySlugSubjectsBySlugSlugGet = <ThrowOnError extends boolean = false>(options: Options<GetSubjectBySlugSubjectsBySlugSlugGetData, ThrowOnError>) => {
    return (options.client ?? client).get<GetSubjectBySlugSubjectsBySlugSlugGetResponses, GetSubjectBySlugSubjectsBySlugSlugGetErrors, ThrowOnError>({
 ...
 */
export const signInWithGoogleUsersGooglePost = <ThrowOnError extends boolean = false>(options: Options<SignInWithGoogleUsersGooglePostData, ThrowOnError>) => {
    return (options.client ?? client).post<SignInWithGoogleUsersGooglePostResponses, SignInWithGoogleUsersGooglePostErrors, ThrowOnError>({
        url: '/users/google',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const previewDiagnosticSetQuestionsDiagnosticSetsSetIdStudentViewGet = <ThrowOnError extends boolean = false>(options: Options<PreviewDiagnosticSetQuestionsDiagnosticSetsSetIdStudentViewGetData, ThrowOnError>) => {
    return (options.client ?? client).get<PreviewDiagnosticSetQuestionsDiagnosticSetsSetIdStudentViewGetResponses, PreviewDiagnosticSetQuestionsDiagnosticSetsSetIdStudentViewGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const exportDiagnosticSetDiagnosticSetsSetIdExportGet = <ThrowOnError extends boolean = false>(options: Options<ExportDiagnosticSetDiagnosticSetsSetIdExportGetData, ThrowOnError>) => {
    return (options.client ?? client).get<ExportDiagnosticSetDiagnosticSetsSetIdExportGetResponses, ExportDiagnosticSetDiagnosticSetsSetIdExportGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 *
 * require_pass 402s (with the upsell payload) for a student without a live
 * pass, which is what the frontend renders the unlock card from. The free
 * report already carries the score, per-question ticks and timing; this is
 * the interpretation those deliberately omit.
 *
 ...
 */
export const getAttemptRadarDiagnosticAttemptsAttemptIdRadarGet = <ThrowOnError extends boolean = false>(options: Options<GetAttemptRadarDiagnosticAttemptsAttemptIdRadarGetData, ThrowOnError>) => {
    return (options.client ?? client).get<GetAttemptRadarDiagnosticAttemptsAttemptIdRadarGetResponses, GetAttemptRadarDiagnosticAttemptsAttemptIdRadarGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const adminOverviewAdminOverviewGet = <ThrowOnError extends boolean = false>(options?: Options<AdminOverviewAdminOverviewGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<AdminOverviewAdminOverviewGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
