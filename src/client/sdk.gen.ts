 ...
 */
export const previewDiagnosticSetQuestionsDiagnosticSetsSetIdPreviewGet = <ThrowOnError extends boolean = false>(options: Options<PreviewDiagnosticSetQuestionsDiagnosticSetsSetIdPreviewGetData, ThrowOnError>) => {
    return (options.client ?? client).get<PreviewDiagnosticSetQuestionsDiagnosticSetsSetIdPreviewGetResponses, PreviewDiagnosticSetQuestionsDiagnosticSetsSetIdPreviewGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
