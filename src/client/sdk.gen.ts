...
export const listPublishedDiagnosticSetsDiagnosticSetsPublishedGet = <ThrowOnError extends boolean = false>(options?: Options<ListPublishedDiagnosticSetsDiagnosticSetsPublishedGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListPublishedDiagnosticSetsDiagnosticSetsPublishedGetResponses, unknown, ThrowOnError>({
...
/**
 * Get Skill Labels
 * The label dictionary for one subject. Empty list when nothing's been
 * named yet — the report falls back to bare S1..S7 codes in that case.
 */
export const getSkillLabelsDiagnosticSkillLabelsGet = <ThrowOnError extends boolean = false>(options: Options<GetSkillLabelsDiagnosticSkillLabelsGetData, ThrowOnError>) => {
    return (options.client ?? client).get<GetSkillLabelsDiagnosticSkillLabelsGetResponses, GetSkillLabelsDiagnosticSkillLabelsGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Update Skill Labels
 * Save a subject's whole label set in one call (the Skills screen edits
 * all seven at once). Each entry's skillCode must be a real core skill; a
 * blank label clears that code (deletes the row) rather than storing an
 * empty name. Returns the resulting label set so the client can re-render
 * from the truth.
 */
export const updateSkillLabelsDiagnosticSkillLabelsPut = <ThrowOnError extends boolean = false>(options: Options<UpdateSkillLabelsDiagnosticSkillLabelsPutData, ThrowOnError>) => {
    return (options.client ?? client).put<UpdateSkillLabelsDiagnosticSkillLabelsPutResponses, UpdateSkillLabelsDiagnosticSkillLabelsPutErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
